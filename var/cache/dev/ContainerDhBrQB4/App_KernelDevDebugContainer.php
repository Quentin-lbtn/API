...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function get_Container_Private_SerializerService()
    {
        ...
        $b = new \ApiPlatform\Core\Swagger\Serializer\ApiGatewayNormalizer(new \ApiPlatform\Core\OpenApi\Serializer\OpenApiNormalizer(($this->privates['.1_Serializer~Fx1j717'] ?? $this->get_1SerializerFx1j717Service())));
        $c = ($this->privates['api_platform.swagger.normalizer.api_gateway'] ?? $this->getApiPlatform_Swagger_Normalizer_ApiGatewayService());
        ...
        $n = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($l, $e, $a, ($this->privates['property_info'] ?? $this->getPropertyInfoService()), new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($l), NULL, []);

        return $this->services['.container.private.serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => $b, 2 => $c, 3 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($d, [], $e), 4 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $e), 5 => $c, 6 => $b, 7 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($f, $g, $h, $i, NULL, $d, ($this->privates['api_platform.subresource_operation_factory.cached'] ?? $this->getApiPlatform_SubresourceOperationFactory_CachedService()), $e), 8 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($f, $j, $d), 9 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($d, true), 10 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 11 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 12 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 13 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($f, $g, $h, $j, $i, $k, $a, $e, $l, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $m), 14 => new \ApiPlatform\Core\Serializer\ItemNormalizer($g, $h, $j, $i, $a, $e, $l, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $f, $m), 15 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 16 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 17 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $e), 18 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 19 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 22 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($k, $i, $j), 'page', 'pagination', $f, $a), $f, $i, ($this->privates['api_platform.filter_locator'] ?? ($this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [], [])))), 23 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 24 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($n, $j, $k), 25 => $n], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => ($this->privates['serializer.encoder.json'] ?? ($this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder())), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\CommunesRepository' => ['privates', 'App\\Repository\\CommunesRepository', 'getCommunesRepositoryService', true],
        ], [
            'App\\Repository\\CommunesRepository' => '?',
        ])));
    ...
    /**
     * Gets the private '.1_Serializer~Fx1j717' shared service.
     *
     * @return \Symfony\Component\Serializer\Serializer
     */
    protected function get_1SerializerFx1j717Service()
    {
        return $this->privates['.1_Serializer~Fx1j717'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService()), ($this->privates['property_info'] ?? $this->getPropertyInfoService()))], [0 => ($this->privates['serializer.encoder.json'] ?? ($this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder()))]);
    }

    /**
     * Gets the private '.service_locator._1ZWX0z' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_1ZWX0zService()
    {
        return $this->privates['.service_locator._1ZWX0z'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.api_doc' => ['privates', 'security.firewall.map.context.api_doc', 'getSecurity_Firewall_Map_Context_ApiDocService', true],
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UR-pQuTSs+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('p41gK57MXu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ypG448qHEg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9Fm7e+E-U7', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Kf7tXXKzwP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Jtx5BeHbGp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3Z0do2cHAe', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator._1ZWX0z'] ?? $this->get_ServiceLocator_1ZWX0zService()), new RewindableGenerator(function () {
            yield 'security.firewall.map.context.dev' => ($this->privates['.security.request_matcher.Iy.T22O'] ?? ($this->privates['.security.request_matcher.Iy.T22O'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/')));
            yield 'security.firewall.map.context.api_doc' => ($this->privates['.security.request_matcher.mYljB3Z'] ?? ($this->privates['.security.request_matcher.mYljB3Z'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/doc')));
