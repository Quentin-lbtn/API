...
class getNelmioApiDoc_Controller_SwaggerJsonService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['nelmio_api_doc.controller.swagger_json'] = new \Nelmio\ApiDocBundle\Controller\DocumentationController(($container->privates['nelmio_api_doc.generator_locator'] ?? $container->load('getNelmioApiDoc_GeneratorLocatorService')));
    }
}
